...
main(){
	...
	do{
		system("cls");
		cout<<"Programa para cargar una lista en orden creciente.\n";
	...
	system("cls");
	cout<<"Lista Cargada ordenada en forma creciente:\n";
	mostrarLista(Lista);
...
/*
2 – Cargar una lista simplemente enlazada en orden creciente. Mostrar los
